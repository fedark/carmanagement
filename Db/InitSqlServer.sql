...
if not exists (select * from Users where Name = 'owner')
...
if not exists (select * from UserRoles where UserId = '03422484-4f6c-4ef7-b4f4-a6ee8c3a71a9' or RoleId = 'beaaa4aa-da9c-4885-a2b8-ad1d84344910')
